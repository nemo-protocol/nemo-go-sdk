...
type ContractInterface interface {
	...
	AddLiquidity(amountFloat float64, sender *account.Account, amountInType string, nemoConfig *models.NemoConfig)(bool, error)
	RedeemLiquidity(expectOut float64, sender *account.Account, amountInType string, nemoConfig *models.NemoConfig)(bool, error)
